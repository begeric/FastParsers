...
case class StringReader(input: Array[Char], offset: Int)

case class OptionAnon1323431030(value: Anon1323431030, defined: Boolean)
...
case class OptionAnon6507737(value: Anon6507737, defined: Boolean)

case class ParseResultAnon6507737B(res: Anon6507737, empty: Boolean, next: StringReader)

case class ParseResultCharB(res: Char, empty: Boolean, next: StringReader)
